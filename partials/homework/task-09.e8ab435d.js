...
})({"alIHE":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "c872ff48e8ab435d";
...
},{}],"d6hZn":[function(require,module,exports) {
...
boxGallery.insertAdjacentHTML("afterbegin", createMarkUp((0, _galleryDefault.default)));
...
function onOpenModal(event) {
    ...
    (0, _galleryDefault.default).forEach((item)=>{
...
function onEscapeClick(event) {
    ...
    if (event.code === "ArrowRight") nextPictures();
    if (event.code === "ArrowLeft") privioslyPictures();
}
function nextPictures() {
    for(let i = 0; i < (0, _galleryDefault.default).length - 1; i += 1)if (imageEl.getAttribute("src") === (0, _galleryDefault.default)[i].original) {
        imageEl.setAttribute("src", (0, _galleryDefault.default)[i + 1].original);
        imageEl.setAttribute("alt", (0, _galleryDefault.default)[i + 1].description);
        return;
    }
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../../data/gallery":"bT4et"}],"gkKU3":[function(require,module,exports) {
...
},{}],"bT4et":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["alIHE","d6hZn"], "d6hZn", "parcelRequired7c6")

//# sourceMappingURL=task-09.e8ab435d.js.map
