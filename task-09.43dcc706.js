...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"data/gallery.js":[function(require,module,exports) {
"use strict";
...
},{}],"js/homeworks/task-09.js":[function(require,module,exports) {
"use strict";

var _gallery = _interopRequireDefault(require("../../data/gallery"));
...
boxGallery.insertAdjacentHTML('afterbegin', createMarkUp(_gallery.default));
...
function nextPictures() {
  for (let i = 0; i < _gallery.default.length - 1; i += 1) {
    if (imageEl.getAttribute('src') === _gallery.default[i].original) {
      imageEl.setAttribute('src', _gallery.default[i + 1].original);
      imageEl.setAttribute('alt', _gallery.default[i + 1].description);
      return;
    }
  }
}
...
},{"../../data/gallery":"data/gallery.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/homeworks/task-09.js"], null)
//# sourceMappingURL=/task-09.43dcc706.js.map